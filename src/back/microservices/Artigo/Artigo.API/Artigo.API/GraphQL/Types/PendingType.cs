...
namespace Artigo.API.GraphQL.Types
{
    ...
    public class PendingType : ObjectType<Pending>
    {
        protected override void Configure(IObjectTypeDescriptor<Pending> descriptor)
        {
            ...
            // TODO: Adicionar um resolver para carregar o Artigo, Staff, ou Volume alvo, dependendo de TargetType.
            // Exemplo de como carregar o Artigo alvo (se TargetType for Artigo):
            // descriptor.Field<TargetEntityResolver>(r => r.GetTargetArtigoAsync(default!, default!, default!))
            //     .Name("targetArtigo")
            //     .Type<ArtigoType>()
            //     .Description("O Artigo alvo, se for relevante.");
        }
    }
}